...
class Visualization {
  ...
  */
  ...
  isHoveringAreaBuffer(buffer) {
    let subBuffer = this.findAreaFromArray(buffer, params.areaPickSize, width / 2, height / 4 ); // mousePick.x, mousePick.y); quest 3 res: 1680x1760 // 1000 works well for width!! 
    return subBuffer;
  }

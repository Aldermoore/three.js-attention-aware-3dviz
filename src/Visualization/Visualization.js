...
class Visualization {
  ...
  */
  ...
  isHoveringAreaBuffer(buffer) {
    let subBuffer = this.findAreaFromArray(buffer, params.areaPickSize, width/1.25, height*3 ); // mousePick.x, mousePick.y); // TODO figure out what the hell is going on here..
    return subBuffer;
  }
